...
namespace Erp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230221001240_AddedCompanyJoinRequestTableAndAddedSomeMoreColumnsToCompanyTables")]
    partial class AddedCompanyJoinRequestTableAndAddedSomeMoreColumnsToCompanyTables
    {
            ...
            modelBuilder.Entity("Erp.Core.Entities.Account.Company", b =>
                {
                    ...
                    b.Property<string>("CompanyOwnerFirstName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("company_owner_first_name");

                    b.Property<string>("CompanyOwnerLastName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("company_owner_last_name");

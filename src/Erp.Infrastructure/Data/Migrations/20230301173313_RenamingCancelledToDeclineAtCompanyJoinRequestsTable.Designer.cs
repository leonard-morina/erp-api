...
namespace Erp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230301173313_RenamingCancelledToDeclineAtCompanyJoinRequestsTable")]
    partial class RenamingCancelledToDeclineAtCompanyJoinRequestsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Core.Entities.Account.CompanyJoinCode", b =>
                {
                    b.Property<string>("CompanyJoinCodeId")
                        .HasColumnType("text")
                        .HasColumnName("company_join_code_id");
                    ...
                    b.HasKey("CompanyJoinCodeId")
                        .HasName("pk_company_join_code");

                    b.HasIndex("CompanyId")
                        .IsUnique()
                        .HasDatabaseName("ix_company_join_code_company_id");

                    b.HasIndex("InsertedByUserId")
                        .HasDatabaseName("ix_company_join_code_inserted_by_user_id");

                    b.HasIndex("ModifiedByUserId")
                        .HasDatabaseName("ix_company_join_code_modified_by_user_id");

                    b.ToTable("company_join_code", (string)null);
                });
            ...
            modelBuilder.Entity("Erp.Core.Entities.Account.CompanyJoinRequest", b =>
                {
                    ...
                    b.Property<bool>("RequestDeclined")
                        .HasColumnType("boolean")
                        .HasColumnName("request_declined");

                    b.Property<string>("RequestDeclinedByUserId")
                        .HasColumnType("text")
                        .HasColumnName("request_declined_by_user_id");

                    b.Property<DateTime?>("RequestDeclinedDateTime")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("request_declined_date_time");
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_company_join_request_company_id");
                    ...
                    b.HasIndex("RequestDeclinedByUserId")
                        .HasDatabaseName("ix_company_join_request_request_declined_by_user_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_company_join_request_user_id");
            ...
            modelBuilder.Entity("Erp.Core.Entities.Account.CompanyJoinCode", b =>
                {
                    b.HasOne("Erp.Core.Entities.Account.Company", "Company")
                        .WithOne("CompanyJoinCode")
                        .HasForeignKey("Erp.Core.Entities.Account.CompanyJoinCode", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_join_code_company_company_id");

                    b.HasOne("Erp.Core.Entities.Account.User", "InsertedByUser")
                        .WithMany()
                        .HasForeignKey("InsertedByUserId")
                        .HasConstraintName("fk_company_join_code_user_inserted_by_user_id");

                    b.HasOne("Erp.Core.Entities.Account.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedByUserId")
                        .HasConstraintName("fk_company_join_code_user_modified_by_user_id");
            ...
            modelBuilder.Entity("Erp.Core.Entities.Account.CompanyJoinRequest", b =>
                {
                    b.HasOne("Erp.Core.Entities.Account.Company", "Company")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_join_request_company_company_id");
                    ...
                    b.HasOne("Erp.Core.Entities.Account.User", "RequestDeclinedByUser")
                        .WithMany()
                        .HasForeignKey("RequestDeclinedByUserId")
                        .HasConstraintName("fk_company_join_request_user_request_declined_by_user_id");
                    ...
                    b.HasOne("Erp.Core.Entities.Account.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_join_request_user_user_id");
                    ...
                    b.Navigation("RequestDeclinedByUser");
